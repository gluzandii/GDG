...
use api_types::auth::login::{ApiAuthLoginRequest, ApiAuthLoginResponse};
use axum::Json;
...
pub async fn api_auth_login_post(
    State(pool): State<PgPool>,
    Json(req): Json<ApiAuthLoginRequest>,
) -> impl IntoResponse {
