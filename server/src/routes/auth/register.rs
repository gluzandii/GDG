...
use api_types::auth::register::{ApiAuthRegisterRequest, ApiRegisterResponse};
use axum::Json;
...
pub async fn api_auth_register_post(
    State(pool): State<PgPool>,
    Json(req): Json<ApiAuthRegisterRequest>,
) -> impl IntoResponse {
